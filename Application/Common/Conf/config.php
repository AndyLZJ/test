...
//***********************************URL设置**************************************
    ...
    'MODULE_ALLOW_LIST'      => array('Home','Admin','Mobile','Api','User','App'), //允许访问列表
    ...
    'UPLOAD_SITEIMG_QINIU' => array (
        ...
        'driver' => 'Qiniu',
        'driverConfig' => array (
            'secretKey' => 'lK57gP5y6YZkElAjufk_oqG7zVHNQr3JfijRiRP_',
            'accessKey' => 'F-retaNPejukc0QVqqKgZTuQo_2yUyQlkljhc6JT',
            'domain' => 'http://v1.occupationedu.com/',
            'bucket' => 'tonguong-video',
            'persistentPipeline'=>'dysoftRYD',
...
//***********************************邮件服务器**********************************
    'EMAIL_FROM_NAME'        => '培训平台消息中心',   // 发件人
    'EMAIL_SMTP'             => 'smtp.163.com',   // smtp
    'EMAIL_USERNAME'         => '13415840216@163.com',   // 账号
    'EMAIL_PASSWORD'         => 'bb13415840216',   // 密码  注意: 163和QQ邮箱是授权码；不是登录的密码
