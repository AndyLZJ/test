...
class QiniuStorage
{
    ...
    public function __construct($config)
    {
        ...
        $this->persistentOps = $config['persistentOps'];
    ...
    public function UploadToken($sk, $ak, $param)
    {
        ...
        return self::SignWithData($this->sk,$this->ak, $data);
    }
...
// URLSafeBase64Encode
    ...
    /** * 对提供的数据进行urlsafe的base64编码。 * * @param string $data 待编码的数据，
     * 一般为字符串 * * @return string 编码后的字符串 *
     */
    ...
    /** * 对提供的urlsafe的base64编码的数据进行解码 * * @param string $str 待解码的数据，一般为字符串 * * @return string 解码后的字符串 */
